...
<div class="multi-group-container">
                    ...
                    <div class="colour four">
                     <p style="text-align: center">Ahafo</p>  

                        <div class="swatch groupcolor ahafo">
                            <div class="color-code"><br>#4B644B</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#4B644B"></rect></svg></div>
                    
     <div class="colour four">
                          <p style="text-align: center">Ashanti</p>  

                        <div class="swatch groupcolor ashanti">
                            <div class="color-code"><br>#7D96AF</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#7D96AF"></rect></svg></div>
                    
     <div class="colour four">
                               <p style="text-align: center">Bono</p>  

                        <div class="swatch groupcolor bono dark">
                            <div class="color-code"><br>#EBA07E</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#EBA07E"></rect></svg></div>


                   
     <div class="colour four">
                                    <p style="text-align: center">Bono East</p>  

                        <div class="swatch groupcolor bonoeast dark">
                            <div class="color-code"><br>#09979B</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#09979B"></rect></svg></div>
                                            </div>
<div class="multi-group-container">
                   
     <div class="colour four">
                                         <p style="text-align: center">Central</p>  

                        <div class="swatch groupcolor central dark">
                            <div class="color-code"><br>#EA879C</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#EA879C"></rect></svg></div>
     
     <div class="colour four">
                                              <p style="text-align: center">Eastern</p>  

                        <div class="swatch groupcolor eastern dark">
                            <div class="color-code"><br>#E5B9AD</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#E5B9AD"></rect></svg></div>
                   
                    
                    
                         <div class="colour four">
                                              <p style="text-align: center">Greater Accra</p>  

                        <div class="swatch groupcolor greateraccra dark">
                            <div class="color-code"><br>#CC9B7A</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#CC9B7A"></rect></svg></div>
                    
                         <div class="colour four">
                                              <p style="text-align: center">Northern</p>  

                        <div class="swatch groupcolor northern dark">
                            <div class="color-code"><br>#FDD835</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#FDD835"></rect></svg></div>
...
<div class="multi-group-container">
     ...
     <div class="colour four">
                                              <p style="text-align: center">North East</p>  

                        <div class="swatch groupcolor northeast dark">
                            <div class="color-code"><br>#0070C0</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#0070C0"></rect></svg></div>
                    
                    
                         <div class="colour four">
                                              <p style="text-align: center">Oti</p>  

                        <div class="swatch groupcolor oti dark">
                            <div class="color-code"><br>#AE2B47</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#AE2B47"></rect></svg></div>
                    
                    
                         <div class="colour four">
                                              <p style="text-align: center">Savannah</p>  

                        <div class="swatch groupcolor savannah dark">
                            <div class="color-code"><br>#F94240</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#F94240"></rect></svg></div>
                    
                    
                    
                         <div class="colour four">
                                              <p style="text-align: center">Upper East</p>  

                        <div class="swatch groupcolor uppereast dark">
                            <div class="color-code"><br>#903000</div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#903000"></rect></svg></div>
...
<div class="colour four">
	<p style="text-align: center">Upper West</p>  
		
		<div class="swatch groupcolor upperwest dark">
			<div class="color-code"><br>#0F3B6C</div>
				</div>
				<svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#0F3B6C"></rect></svg></div>
					
					
					<div class="colour four">
						<p style="text-align: center">Volta</p>  
							
							<div class="swatch groupcolor volta dark">
								<div class="color-code"><br>#59A77F</div>
									</div>
									<svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#59A77F"></rect></svg></div>
										
										
										<div class="colour four">
											<p style="text-align: center">Western</p>  
												
												<div class="swatch groupcolor western dark">
													<div class="color-code"><br>#FDAE6B</div>
														</div>
														<svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#FDAE6B"></rect></svg></div>
															
															
															
															<div class="colour four">
																<p style="text-align: center">Western North</p>  
																	
																	<div class="swatch groupcolor westernnorth dark">
																		<div class="color-code"><br>#B173A0</div>
																			</div>
																			<svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#B173A0"></rect></svg></div>
...
<div class="multi-group-container">
                    ...
                    <p style="text-align:center">Missing</p>
                        <div class="swatch groupcolor missing">
                            <div class="color-code"><br>#ADABAC <br></div>
                        </div>
                    <svg width="30" height="30" class="print-swatch"><rect width="30" height="30" fill="#ADABAC"></rect></svg></div>
                </div>
